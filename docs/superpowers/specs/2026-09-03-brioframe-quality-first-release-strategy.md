...
- correct template identity and thumbnail pairing
- sharp hero and interior visuals
- intentional desktop and mobile behavior
- no malformed or irrelevant imagery
- distinct structure relative to neighboring variants
- clear conversion path appropriate to the industry
- no fabricated Shopify purchase URL
- exact verified Shopify link when available
